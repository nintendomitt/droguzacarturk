...
# ------------------------------------------------------------------ 1
{"slug": "hidradenitis-suppurativa-nedir", "sources": KAYNAK,
 "date": "2026-09-17",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa (Hidradenit) Nedir? Belirtileri ve Tedavisi",
 "ogtitle": "Hidradenitis suppurativa nedir, neden tekrar eder?",
 "desc": "Hidradenitis suppurativa (hidradenit), koltuk altı ve kasıkta tekrarlayan ağrılı şişlik ve akıntıyla giden kronik bir deri hastalığıdır. Neden tekrar eder?",
 "h1": "Hidradenitis suppurativa (hidradenit) nedir?",
...
# ------------------------------------------------------------------ 2
{"slug": "koltuk-alti-ciban-neden-cikar", "sources": KAYNAK,
 "date": "2026-09-18",
 "cat": "Hidradenit",
 "title": "Koltuk Altı Çıban Neden Çıkar, Neden Geçmiyor?",
 "ogtitle": "Koltuk altı çıban neden çıkar, neden geçmez?",
 "desc": "Koltuk altı çıban çıkıp boşaltılıyor ama birkaç ay sonra aynı yere dönüyorsa, bu sıradan bir apse değil hidradenit olabilir. Ayırt edici bulgular.",
 "h1": "Koltuk altı çıban neden çıkar, neden geçmiyor?",
 "lead": "Koltuk altı çıban çıkıyor, boşaltılıyor, birkaç hafta rahatlıyorsunuz — sonra <strong>aynı noktada yeniden başlıyor</strong>. Bu döngü iki-üç kez tekrarladıysa artık sıradan bir çıbandan söz etmiyoruz. Tekrarlayan koltuk altı çıbanının en sık nedeni <strong>hidradenitis suppurativa</strong>dır ve bu hastalıkta tedavi mantığı tamamen farklıdır: sorun o anki iltihap değil, deri altında kalıcı hale gelmiş kanallardır.",
...
# ------------------------------------------------------------------ 3
{"slug": "hidradenitis-suppurativa-belirtileri", "sources": KAYNAK,
 "date": "2026-09-19",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa Belirtileri: İlk Bulgular ve Uyarılar",
 "ogtitle": "Hidradenitis suppurativa belirtileri nelerdir?",
 "desc": "Hidradenitis suppurativanın ilk belirtisi koltuk altı veya kasıkta tekrarlayan ağrılı şişliktir. Deri altı sert bant, ikili komedon ve akıntı tanıyı güçlendirir.",
 "h1": "Hidradenitis suppurativa belirtileri",
...
# ------------------------------------------------------------------ 4
{"slug": "hidradenitis-suppurativa-hangi-doktora-gidilir", "sources": KAYNAK,
 "date": "2026-09-20",
 "cat": "Hasta Rehberi",
 "title": "Hidradenitis Suppurativa Hangi Doktora Gidilir, Hangi Bölüm Bakar?",
 "ogtitle": "Hidradenitis suppurativa hangi bölüm bakar?",
 "desc": "Hidradenitis suppurativada ilk adres dermatolojidir. Deri altında kalıcı kanal ve nedbe oluştuysa plastik ve rekonstrüktif cerrahi devreye girer.",
 "h1": "Hidradenitis suppurativa hangi doktora gidilir?",
 "lead": "Hidradenitis suppurativaya hangi bölüm bakar? Kısa cevap: <strong>iki branş birlikte çalışır</strong>. İlk başvuru adresi <strong>dermatolojidir</strong>: tanı, evreleme ve ilaç tedavisi oradadır ve hastaların önemli bir bölümü bu aşamada kontrol altına alınır. Deri altında kalıcı kanallar, sürekli akıntı ve sertleşmiş nedbe oluştuysa <strong>plastik ve rekonstrüktif cerrahi</strong> devreye girer. Doğru sıra budur — tersi değil.",
...
# ------------------------------------------------------------------ 5
{"slug": "hidradenitis-suppurativa-evreleri", "sources": KAYNAK,
 "date": "2026-09-21",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa Evreleri: Hurley 1, 2 ve 3",
 "ogtitle": "Hidradenitis suppurativa evreleri nasıl ayrılır?",
 "desc": "Hidradenitis suppurativa üç Hurley evresine ayrılır. Erken evrede ilaç, evre 3'te cerrahi öne çıkar. Hangi bulgular hangi evreyi gösterir?",
 "h1": "Hidradenitis suppurativa evreleri (Hurley)",
 "lead": "Hidradenitis suppurativada tedavi kararı <strong>evreye göre</strong> verilir. Kullanılan sistem <strong>Hurley evrelemesi</strong>dir ve üç basamaklıdır. Ayrımı yapan tek şey iltihabın şiddeti değil, <strong>deri altında kalıcı kanal (sinüs traktı) ve nedbe olup olmadığıdır</strong>. Erken evrede (Hurley 1) ilaç öndedir; evre 3'te cerrahi kaçınılmaz hale gelir.",
...
# ------------------------------------------------------------------ 6
{"slug": "ter-bezi-iltihabi-mi-hidradenit-mi", "sources": KAYNAK,
 "date": "2026-09-22",
 "cat": "Hidradenit",
 "title": "Ter Bezi İltihabı mı, Hidradenit mi? Neden Olur?",
 "ogtitle": "Ter bezi iltihabı denen tablo aslında nedir?",
 "desc": "Halk arasında ter bezi iltihabı denen tekrarlayan çıban, çoğunlukla hidradenitis suppurativadır. Ter bezinden değil, kıl folikülünün tıkanmasından başlar.",
 "h1": "Ter bezi iltihabı mı, hidradenit mi?",
 "lead": "Koltuk altında ya da kasıkta tekrar tekrar çıkan iltihaplı şişliklere halk arasında <strong>\"ter bezi iltihabı\"</strong> denir. Bu adlandırma yaygındır ama yanlıştır: tablo <strong>hidradenitis suppurativa</strong>dır ve ter bezinden değil, <strong>kıl folikülünün tıkanmasından</strong> başlar. Bu ayrım önemsiz bir isim tartışması değil — tedavinin nereden başlayacağını doğrudan belirler. Ter bezine yönelik yaklaşımlar bu hastalıkta sonuç vermez.",
...
{"slug": "hidradenit-bulasici-mi", "sources": KAYNAK,
 "date": "2026-09-23",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa Bulaşıcı mı? Akıntı ve Temas",
 "ogtitle": "Hidradenitis suppurativa bulaşıcı mı?",
 "desc": "Hidradenitis suppurativa bulaşıcı değildir. Akıntı, temas, ortak havlu veya cinsel yolla geçmez. Neden bulaşıcı sanıldığı ve gerçekte ne olduğu.",
 "h1": "Hidradenitis suppurativa bulaşıcı mı?",
 "lead": "<strong>Hayır, hidradenitis suppurativa bulaşıcı değildir.</strong> Ne temasla, ne ortak havlu ya da kıyafetle, ne havuz veya hamamla, ne de cinsel yolla geçer. Hastalık bir mikrobun vücuda girmesiyle başlamaz; <strong>kıl folikülünün tıkanması</strong> ve buna verilen aşırı bağışıklık yanıtıyla gelişir. Akıntının varlığı bulaşıcılık anlamına gelmez.",
...
# ------------------------------------------------------------------ 8
{"slug": "hidradenitis-suppurativa-ameliyati", "sources": KAYNAK,
 "date": "2026-09-24",
 "cat": "Tedavi",
 "title": "Hidradenitis Suppurativa Ameliyatı Nasıl Yapılır?",
 "ogtitle": "Hidradenitis suppurativa ameliyatı nasıl yapılır?",
 "desc": "İleri evre hidradenitis suppurativada etkilenmiş bölge bütünüyle çıkarılır ve oluşan açıklık flep ya da greftle onarılır. Ameliyatın adımları ve seçenekler.",
 "h1": "Hidradenitis suppurativa ameliyatı nasıl yapılır?",
 "lead": "İleri evre hidradenitis suppurativada ameliyatın mantığı tek cümleye sığar: <strong>hastalıklı ter bezi bölgesinin tamamı çıkarılmadan hastalık durmaz</strong>. Bu nedenle yapılan işlem apse boşaltmak değil, etkilenmiş alanın sağlam dokuya kadar bütünüyle çıkarılması (geniş eksizyon) ve oluşan açıklığın <strong>flep ya da greftle onarılmasıdır</strong>. Sınırlı çıkarma, geride kalan dokuda nüks demektir.",
...
# ------------------------------------------------------------------ 9
{"slug": "hidradenitis-suppurativa-ameliyati-sonrasi", "sources": KAYNAK,
 "date": "2026-09-25",
 "cat": "Hasta Rehberi",
 "title": "Hidradenitis Suppurativa Ameliyatı Sonrası İyileşme Süreci",
 "ogtitle": "Hidradenitis suppurativa ameliyatı sonrası ne olur?",
 "desc": "Hidradenitis suppurativa ameliyatı sonrası ilk günden üçüncü aya kadar ne olur? Hareket kısıtlaması, yara bakımı, egzersizler ve işe dönüş.",
 "h1": "Hidradenitis suppurativa ameliyatı sonrası iyileşme",
 "lead": "Hidradenitis suppurativa ameliyatından sonraki iyileşme, çıkarılan alanın genişliğine ve kapatma yöntemine göre değişir. Genel çerçeve şudur: <strong>ilk 2-4 hafta hareket kısıtlaması</strong>, ardından <strong>kontraktüre karşı egzersiz dönemi</strong> ve <strong>6-8 haftada büyük ölçüde iyileşme</strong>. Bu sürecin en kritik parçası yaranın kapanması değil, bölgenin <strong>hareketinin geri kazanılmasıdır</strong>.",
...
# ------------------------------------------------------------------ 10
{"slug": "hidradenitis-suppurativa-tekrarlar-mi", "sources": KAYNAK,
 "date": "2026-09-26",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa Ameliyattan Sonra Tekrarlar mı?",
 "ogtitle": "Hidradenitis suppurativa ameliyattan sonra tekrarlar mı?",
 ...
 "h1": "Hidradenitis suppurativa tekrarlar mı?",
 "lead": "Dürüst cevap: <strong>tekrarlama mümkündür.</strong> Ancak burada iki farklı şeyi ayırmak gerekir. Bütünüyle çıkarılmış bir bölgede hastalığın <strong>aynı yerde</strong> tekrarlaması belirgin biçimde nadirdir. Buna karşılık hidradenitis suppurativa sistemik bir yatkınlıkla ilişkili olduğu için <strong>başka bir bölgede</strong> yeni bir odak başlayabilir. \"Nüks etti\" denen durumların çoğu aslında ikincisidir.",
...
# ------------------------------------------------------------------ 11
{"slug": "hidradenitis-suppurativa-ve-sigara", "sources": KAYNAK,
 "date": "2026-09-27",
 "cat": "Hidradenit",
 "title": "Hidradenitis Suppurativa ve Sigara: Bırakmak Fark Yaratır mı?",
 "ogtitle": "Hidradenitis suppurativada sigaranın etkisi",
 "desc": "Sigara, hidradenitis suppurativa ile ilişkisi en güçlü gösterilmiş etkendir. Alevlenmeyi artırır, ameliyat sonrası yara iyileşmesini bozar. Bırakmanın etkisi.",
 "h1": "Hidradenitis suppurativa ve sigara",
 "lead": "Hidradenitis suppurativada <strong>sigara, ilişkisi en güçlü gösterilmiş çevresel etkendir</strong>. İki ayrı yerden zarar verir: hastalığın kendi seyrini ağırlaştırır ve ameliyat gerekirse <strong>yara iyileşmesini doğrudan bozar</strong>. Bu yüzden sigarayı bırakmak, tedaviye eşlik eden bir öneri değil, <strong>tedavinin kendisinin bir parçasıdır</strong>.",
...
{"slug": "hidradenit-mi-ciban-mi-kist-mi", "sources": KAYNAK,
 "date": "2026-09-28",
 "cat": "Ayrım",
 "title": "Çıban mı, Kist mi, Hidradenit mi? Ayırt Etme Rehberi",
 "ogtitle": "Çıban, kist ve hidradenit arasındaki fark",
 "desc": "Hidradenitis suppurativa, çıban (fronkül) ve iltihaplı kist benzer görünür ama tedavileri farklıdır. Tekrarlama, yerleşim ve deri altı kanal ayrımı.",
 "h1": "Çıban mı, kist mi, hidradenit mi?",
...
# ------------------------------------------------------------------ 13
{"slug": "kasikta-ciban-neden-cikar", "sources": KAYNAK,
 "date": "2026-09-29",
 "cat": "Hidradenit",
 "title": "Kasıkta Çıban Neden Çıkar? Tekrarlıyorsa Hidradenit Olabilir",
 "ogtitle": "Kasıkta çıban neden çıkar, nasıl geçer?",
 "desc": "Kasıkta tekrarlayan çıban ve akıntı, çoğu zaman hidradenitis suppurativadır. Bölgeye özgü bulgular, ayrım ve cerrahi planlamada dikkat edilenler.",
 "h1": "Kasıkta çıban neden çıkar?",
 "lead": "Kasıkta çıkan ağrılı, iltihaplı şişlikler tek seferlikse genellikle sıradan bir çıbandır. Ancak <strong>aynı bölgede tekrar tekrar çıkıyor, akıntı yapıyor ve iz bırakıyorsa</strong>, bu tablo büyük olasılıkla <strong>hidradenitis suppurativa</strong>dır. Kasık, hastalığın koltuk altından sonra en sık tuttuğu bölgedir ve iki nedenle ayrı ele alınır: bölge sürekli hareket eder ve nemli kalır.",
